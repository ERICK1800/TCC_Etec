  ...
  <body ng-app="mainModule" ng-controller="mainController" class="light-blue lighten-2">
    ...
    <div id="login-page" class="row">
        <div class="col s12 z-depth-6 card-panel">
          <form class="login-form" action="insertUser_admin.php"  method="post">
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input type="submit" value="Resgistrar" id="botao" class="btn waves-effect waves-light light-blue lighten-2 col s12">
                </div>
            </div>        
            </div>
          </form>
